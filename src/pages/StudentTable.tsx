...
const StudentTable: React.FC = () => {
    ...
    const { getAllStudentsListDataByApi, storeAllStudentList } = context;
    ...
    const exportExcel = () => {
        import('xlsx').then((xlsx) => {
            ...
            const data = storeAllStudentList.map((row) =>
            ...
            saveAsExcelFile(excelBuffer, 'Student-table');
        });
    };
